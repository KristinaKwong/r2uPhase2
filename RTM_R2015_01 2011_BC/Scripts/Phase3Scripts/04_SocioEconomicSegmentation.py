...
class SocioEconomicSegmentation(_m.Tool()):
    ...
    def Generate_Data_Frame(self, eb):
        ...
        # TODO replace this with data import
        # This part can be killed
        ...
        ###################################################
        # TODO replace with import of densities
        # import densities
        ...
        # should be able to pull this directly from sqlite database
    ...
    def Init_Matrices(self, eb):
        util = _m.Modeller().tool("translink.emme.util")
        ##HHxWorkers
        # TODO fix these references - These are not the correct locations
