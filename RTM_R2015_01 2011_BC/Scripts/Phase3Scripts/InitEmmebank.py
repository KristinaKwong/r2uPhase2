...
class InitEmmebank(_m.Tool()):
    ...
    def initfunctions(self, eb):
        ...
        eb.create_function("ft03", "timau + 1 * length + us1")
        eb.create_function("ft04", "timau + .5 * length + us1")
        eb.create_function("ft05", "timau * 1.5 + us1")
        eb.create_function("ft06", "length * 1 + us1")
        eb.create_function("ft07", "(60 * length / speed) + us1")
        eb.create_function("ft10", "0.01 + us1")
