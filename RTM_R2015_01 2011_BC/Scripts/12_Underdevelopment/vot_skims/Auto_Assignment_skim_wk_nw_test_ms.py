...
class AutoAssignment(_m.Tool()):
    ...
    def auto_assignment(self, am_scenario, md_scenario, pm_scenario, stopping_criteria):
        ...
        #S1
        travel_time_list_s1 = ["mf6300", "mf6301", "mf6302"]
        distance_list_s1 = ["mf6303", "mf6304", "mf6305"]
        #S2
        travel_time_list_s2 = ["mf6306", "mf6307", "mf6308"]
        distance_list_s2 = ["mf6309", "mf6310", "mf6311"]
        #S3
        travel_time_list_s3 = ["mf6312", "mf6313", "mf6314"]
        distance_list_s3 = ["mf6315", "mf6316", "mf6317"]
        #S4
        travel_time_list_s4 = ["mf6318", "mf6319", "mf6320"]
        distance_list_s4 = ["mf6321", "mf6322", "mf6323"]
        #S5
        travel_time_list_s5 = ["mf6324", "mf6325", "mf6326"]
        distance_list_s5 = ["mf6330", "mf6331", "mf6332"]
        #S6
        travel_time_list_s6 = ["mf6333", "mf6334", "mf6335"]
        distance_list_s6 = ["mf6336", "mf6337", "mf6338"]
        #S7
        travel_time_list_s7 = ["mf6339", "mf6340", "mf6341"]
        distance_list_s7 = ["mf6342", "mf6343", "mf6348"]
        #S8
        travel_time_list_s8 = ["mf6350", "mf6351", "mf6352"]
        distance_list_s8 = ["mf6353", "mf6354", "mf6355"]
        #S9
        travel_time_list_s9 = ["mf6356", "mf6357", "mf6358"]
        distance_list_s9 = ["mf6359", "mf6360", "mf6361"]
        #S10
        travel_time_list_s10 = ["mf6362", "mf6363", "mf6364"]
        distance_list_s10 = ["mf6365", "mf6366", "mf6367"]
        #S11
        travel_time_list_s11 = ["mf6368", "mf6369", "mf6370"]
        distance_list_s11 = ["mf6371", "mf6375", "mf6376"]
        #S12
        travel_time_list_s12 = ["mf6377", "mf6378", "mf6379"]
        distance_list_s12 = ["mf6380", "mf6381", "mf6382"]

        travel_time_list_wk = ["mf2031", "mf2034", "mf2037"]
        distance_list_wk = ["mf2030", "mf2033", "mf2036"]
        
        travel_time_list_nw = ["mf2031", "mf2034", "mf2037"]
        distance_list_nw = ["mf2030", "mf2033", "mf2036"]        
        ...
        for scenario, demands, travel_time_nw, distance_nw, travel_time_wk, distance_wk  in input_items:
            ...
            spec["classes"][0]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s1[0]}
            spec["classes"][0]["analysis"] = {"results": {"od_values": distance_list_s1[0]}}

            spec["classes"][1]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s2[0]}
            spec["classes"][1]["analysis"] = {"results": {"od_values": distance_list_s2[0]}}
            
            spec["classes"][2]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s3[0]}
            spec["classes"][2]["analysis"] = {"results": {"od_values": distance_list_s3[0]}}        

            spec["classes"][3]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s4[0]}
            spec["classes"][3]["analysis"] = {"results": {"od_values": distance_list_s4[0]}}        

            spec["classes"][4]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s5[0]}
            spec["classes"][4]["analysis"] = {"results": {"od_values": distance_list_s5[0]}}

            spec["classes"][5]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s6[0]}
            spec["classes"][5]["analysis"] = {"results": {"od_values": distance_list_s6[0]}}

            spec["classes"][6]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s7[0]}
            spec["classes"][6]["analysis"] = {"results": {"od_values": distance_list_s7[0]}}

            spec["classes"][7]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s8[0]}
            spec["classes"][7]["analysis"] = {"results": {"od_values": distance_list_s8[0]}}

            spec["classes"][8]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s9[0]}
            spec["classes"][8]["analysis"] = {"results": {"od_values": distance_list_s9[0]}}

            spec["classes"][9]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s10[0]}
            spec["classes"][9]["analysis"] = {"results": {"od_values": distance_list_s10[0]}}        
            
            spec["classes"][10]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s11[0]}
            spec["classes"][10]["analysis"] = {"results": {"od_values": distance_list_s11[0]}}

            spec["classes"][11]["results"]["od_travel_times"] = {"shortest_paths": travel_time_list_s12[0]}
            spec["classes"][11]["analysis"] = {"results": {"od_values": distance_list_s12[0]}}        
