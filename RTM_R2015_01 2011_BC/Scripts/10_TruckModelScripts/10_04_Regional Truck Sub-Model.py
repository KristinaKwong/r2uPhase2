...
class RegTruckModel(_modeller.Tool()):
	...
	def page(self):
		...
		pb = _modeller.ToolPageBuilder(self, title="Regional Truck Trips Model",
		   description="Generates base/future forecasts for regional light and heavy trucks trips",
