...
class InitEmmebank(_m.Tool()):
    ...
    def initconstants(self, eb):
        ...
        util.initmat(eb, "ms60", "WkOcA", "Wk AM occupancy rate", 3.46)
        util.initmat(eb, "ms61", "UvOcA", "Uv AM occupancy rate", 3.31)
        util.initmat(eb, "ms62", "ScOcA", "Sc AM occupancy rate", 2.97)
        util.initmat(eb, "ms63", "ShOcA", "Sh AM occupancy rate", 2.36)
        util.initmat(eb, "ms64", "PBOcA", "PB AM occupancy rate", 2.32)
        util.initmat(eb, "ms65", "SoOcA", "So AM occupancy rate", 2.62)
        util.initmat(eb, "ms66", "EcOcA", "Ec AM occupancy rate", 2.59)
        util.initmat(eb, "ms67", "NwOcA", "Nw AM occupancy rate", 2.32)
        util.initmat(eb, "ms68", "NoOcA", "No AM occupancy rate", 2.58)
        ...
        util.initmat(eb, "ms102", "TDOpC1", "Trip Dist Operating Cost", 0.13)
