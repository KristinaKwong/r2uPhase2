...
class PreLoop(_m.Tool()):
    ...
    def __call__(self, eb):
        ...
        util.initmat(eb, "mf2100", "kAuDsP", "Final Skim AutoDistancePM", 0)
        util.initmat(eb, "mf2101", "kAuTmP", "Final Skim AutoTimePM", 0)
        util.initmat(eb, "mf2102", "kAuTlP", "Final Skim AutoTollPM", 0)
        util.initmat(eb, "mf2106", "kBsWtP", "Final Skim BusTotalWaitPM", 0)
        util.initmat(eb, "mf2107", "kBsIvP", "Final Skim BusIVTTPM", 0)
        util.initmat(eb, "mf2108", "kBsBrP", "Final Skim BusAvgBoardPM", 0)
        util.initmat(eb, "mf2109", "kBsAxP", "Final Skim BusAuxPM", 0)
        util.initmat(eb, "mf2110", "kBsFlP", "Final Skim BusFlagPM", 0)
        util.initmat(eb, "mf2116", "kRBIvP", "Final Skim RailBusIVTTPM", 0)
        util.initmat(eb, "mf2117", "kRRIvP", "Final Skim RailRailIVTTPM", 0)
        util.initmat(eb, "mf2118", "kRlWtP", "Final Skim RailTotalWaitPM", 0)
        util.initmat(eb, "mf2119", "kRlBrP", "Final Skim RailAvgBoardPM", 0)
        util.initmat(eb, "mf2120", "kRlAxP", "Final Skim RailAuxPM", 0)
        util.initmat(eb, "mf2121", "kRlFlP", "Final Skim RailFlagPM", 0)
        util.initmat(eb, "mf2122", "kRAFlP", "Final Skim AuxFlagPM", 0)
        util.initmat(eb, "mf2123", "kTRFlP", "Final Skim TotalRlTimeFlagPM", 0)
        util.initmat(eb, "mf2163", "kTrOvP", "Final Skim TransitOVTTPM", 0)
        util.initmat(eb, "mf2164", "kTrIvP", "Final Skim TransitIVTTPM", 0)
        ...
        util.initmat(eb, "mf869", "f1117v", "f1117v", 0)
        util.initmat(eb, "mf870", "f1217v", "f1217v", 0)
        util.initmat(eb, "mf871", "f1317v", "f1317v", 0)
        util.initmat(eb, "mf872", "f2117v", "f2117v", 0)
        util.initmat(eb, "mf873", "f2417v", "f2417v", 0)
        util.initmat(eb, "mf874", "f1127v", "f1127v", 0)
        util.initmat(eb, "mf875", "f1227v", "f1227v", 0)
        util.initmat(eb, "mf876", "f1327v", "f1327v", 0)
        util.initmat(eb, "mf877", "f2127v", "f2127v", 0)
        util.initmat(eb, "mf878", "f2427v", "f2427v", 0)
        util.initmat(eb, "mf879", "f3547b", "f3547b", 0.0000001)
        util.initmat(eb, "mf880", "f3557r", "f3557r", 0.0000001)
        ...
        specs.append(util.matrix_spec("mf873", "mf897"))
        specs.append(util.matrix_spec("mf878", "mf898"))
