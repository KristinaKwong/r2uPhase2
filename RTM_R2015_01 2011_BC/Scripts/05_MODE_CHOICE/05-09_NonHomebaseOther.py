...
class ModeChoiceNHBO(_modeller.Tool()):
    def page(self):
...
@_modeller.logbook_trace("Non-home-base other")
...
@_modeller.logbook_trace("continue aggregating non work demand, non-homebase other")
...
def old_calculate_probabilities(scenario):
    ...
    for i in range(3):
        ...
        for k in range(7):
            ...
            if 4 < k < 7:
                newexp = ("((" + expression3 + ")" + "/" + "((" + expression1 + ")+" + "(" + expression2 + ")+" +
                          "(" + expression3 + ")))" + "*" + "(" + e + "^" + "(mf" + str(
                    startmf + i + k * 9) + "))" + "/" + "(" + tiny + "+" + e +
                          "^" + "(mf" + str(startmf + i + 5 * 9) + ")+" + e + "^" + "(mf" + str(
                    startmf + i + 6 * 9) + "))")
...
@_modeller.logbook_trace("Calculate_non_home_base_other")
...
#********
@_modeller.logbook_trace("Time slice non-home base others")
...
def calculate_final_period_demand(scenario):
    ...
    spec_list.append(build_spec("mf852+" + "(mf805/" + msAutOccNhbO2Plus + ")", "mf852"))
    ...
    spec_list.append(build_spec("mf865+" + "(mf806/" + msAutOccNhbO2PlusM + ")", "mf865"))
    ...
    spec_list.append(build_spec("mf878+" + "(mf807/" + msAutOccNhbO2Plus + ")", "mf878"))
