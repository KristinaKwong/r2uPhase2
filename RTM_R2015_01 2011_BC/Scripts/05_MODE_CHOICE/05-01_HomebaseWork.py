...
#            utilities.export_matrices_report(eb, "work", range(710, 843))
    ...
    def calculate_walk(self, scenario):
        ...
        #au_dst
        expression_2 = (wlk_dens + "*(((md5+md6+md7+md8+md9+md10+md11)*10000/(md17+0.000001*(q.le.130))).min.200)"
                        + " + " + sen20_wk
    ...
    def calculate_blends(self, scenario):
        ...
        specs = []
        specs.append(util.matrix_spec("mf140", "(mf110.eq.1)*(ms50+((mf115.eq.0)*(1-ms50)))"))
        specs.append(util.matrix_spec("mf141", "1-mf140"))
        specs.append(util.matrix_spec("mf142", "(mf121.eq.1)*(ms50+(((mf129.eq.0)+(mf130.eq.0)).ge.1)*(1-ms50))"))
        specs.append(util.matrix_spec("mf143", "1-mf142"))
        specs.append(util.matrix_spec("mf144", "mf100*ms50+mf103*(1-ms50)"))
        specs.append(util.matrix_spec("mf145", "mf101*ms50+mf104*(1-ms50)"))
        specs.append(util.matrix_spec("mf146", "mf102*ms50+mf105*(1-ms50)"))
