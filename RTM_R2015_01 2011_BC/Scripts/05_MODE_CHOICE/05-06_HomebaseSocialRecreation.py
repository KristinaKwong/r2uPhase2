...
def calculate_final_period_demand(scenario):
    ...
    spec_list.append(build_spec("mf851+" + "(mf784/" + msAutOccSocR2Plus + ")", "mf851"))
    spec_list.append(build_spec("mf852+" + "(mf805/" + msAutOccSocR2Plus + ")", "mf852"))
    ...
    spec_list.append(build_spec("mf864+" + "(mf785/" + msAutOccSocR2PlusM + ")", "mf864"))
    spec_list.append(build_spec("mf865+" + "(mf806/" + msAutOccSocR2PlusM + ")", "mf865"))
    ...
    spec_list.append(build_spec("mf877+" + "(mf786/" + msAutOccSocR2Plus + ")", "mf877"))
    spec_list.append(build_spec("mf878+" + "(mf807/" + msAutOccSocR2Plus + ")", "mf878"))
