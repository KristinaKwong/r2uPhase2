...
#            utilities.export_matrices_report(eb, "Univ", range(773, 843))
    ...
    def calculate_blends(self, scenario):
        ...
        specs = []
        specs.append(util.matrix_spec("mf140", "(mf110.eq.1)*(ms51+((mf115.eq.0)*(1-ms51)))"))
        specs.append(util.matrix_spec("mf141", "1-mf140"))
        specs.append(util.matrix_spec("mf142", "(mf121.eq.1)*(ms51+(((mf129.eq.0)+(mf130.eq.0)).ge.1)*(1-ms51))"))
        specs.append(util.matrix_spec("mf143", "1-mf142"))
        specs.append(util.matrix_spec("mf144", "mf100*ms51+mf103*(1-ms51)"))
        specs.append(util.matrix_spec("mf145", "mf101*ms51+mf104*(1-ms51)"))
        specs.append(util.matrix_spec("mf146", "mf102*ms51+mf105*(1-ms51)"))
        ...
        specs.append(util.matrix_spec("mf158", "(mf100.lt.15)"))
