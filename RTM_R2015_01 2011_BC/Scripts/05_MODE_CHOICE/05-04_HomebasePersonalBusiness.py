...
##---------------------------------------------------
## 05-04 HBPERBBUS Mode Choice Model
...
class ModeChoiceHBPB(_modeller.Tool()):
    def page(self):
...
@_modeller.logbook_trace("Home-base Personal Business")
def run_model(scenario, data_folder, iteration_number, is_last_iteration):
    ...
    time_slice_personal_business(scenario, data_folder)
...
@_modeller.logbook_trace("continue aggregating non work demand, personal business")
...
def old_calculate_probabilities(scenario):
    ...
    ## Probabilities are saved in matrices mf441-mf503
    ## and are calculated from utilities stored in matrices mf374-mf436
...
@_modeller.logbook_trace("Calculate Blended Skims, personal business")
...
#********
@_modeller.logbook_trace("Time slice personal business")
def time_slice_personal_business(scenario, data_folder):
...
#********
@_modeller.logbook_trace("Calculate final period demand")
def calculate_final_period_demand(scenario):
    ...
    spec_list.append(build_spec("mf847+" + "mf798", "mf847"))
    spec_list.append(build_spec("mf851+" + "(mf784/" + msAutOccPerB2Plus + ")", "mf851"))
    spec_list.append(build_spec("mf852+" + "(mf805/" + msAutOccPerB2Plus + ")", "mf852"))
    ...
    spec_list.append(build_spec("mf864+" + "(mf785/" + msAutOccPerB2PlusM + ")", "mf864"))
    spec_list.append(build_spec("mf865+" + "(mf806/" + msAutOccPerB2PlusM + ")", "mf865"))
    ...
    spec_list.append(build_spec("mf877+" + "(mf786/" + msAutOccPerB2Plus + ")", "mf877"))
    spec_list.append(build_spec("mf878+" + "(mf807/" + msAutOccPerB2Plus + ")", "mf878"))
