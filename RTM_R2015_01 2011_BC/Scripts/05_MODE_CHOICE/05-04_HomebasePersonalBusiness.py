...
#            utilities.export_matrices_report(eb, "pBusi", range(773, 843))
    ...
    def calculate_blends(self, scenario):
        ...
        specs = []
        specs.append(util.matrix_spec("mf140", "(mf110.eq.1)*(ms54+((mf115.eq.0)*(1-ms54)))"))
        specs.append(util.matrix_spec("mf141", "1-mf140"))
        specs.append(util.matrix_spec("mf142", "(mf121.eq.1)*(ms54+(((mf129.eq.0)+(mf130.eq.0)).ge.1)*(1-ms54))"))
        specs.append(util.matrix_spec("mf143", "1-mf142"))
        specs.append(util.matrix_spec("mf144", "mf100*ms54+mf103*(1-ms54)"))
        specs.append(util.matrix_spec("mf145", "mf101*ms54+mf104*(1-ms54)"))
        specs.append(util.matrix_spec("mf146", "mf102*ms54+mf105*(1-ms54)"))
    ...
    def calculate_final_period_demand(self, scenario):
        ...
        specs.append(util.matrix_spec("mf851", "mf851+" + "(mf784/" + msAutOccPerB2Plus + ")"))
        specs.append(util.matrix_spec("mf852", "mf852+" + "(mf805/" + msAutOccPerB2Plus + ")"))
        ...
        specs.append(util.matrix_spec("mf864", "mf864+" + "(mf785/" + msAutOccPerB2PlusM + ")"))
        specs.append(util.matrix_spec("mf865", "mf865+" + "(mf806/" + msAutOccPerB2PlusM + ")"))
        ...
        specs.append(util.matrix_spec("mf877", "mf877+" + "(mf786/" + msAutOccPerB2Plus + ")"))
        specs.append(util.matrix_spec("mf878", "mf878+" + "(mf807/" + msAutOccPerB2Plus + ")"))
