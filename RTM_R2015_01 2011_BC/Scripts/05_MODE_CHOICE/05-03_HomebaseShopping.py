...
class ModeChoiceHBShopping(_m.Tool()):
    ...
    def time_slice_shopping(self, scenario, data_folder):
    ...
    def calculate_final_period_demand(self, scenario):
        ...
        specs.append(build_spec("mf846+" + "mf777*.35", "mf846"))
        specs.append(build_spec("mf847+" + "mf798*.35", "mf847"))
        specs.append(build_spec("mf851+" + "(mf784*.35/" + msAutOccShop2Plus + ")", "mf851"))
        specs.append(build_spec("mf852+" + "(mf805*.35/" + msAutOccShop2Plus + ")", "mf852"))
        ...
        specs.append(build_spec("mf864+" + "(mf785/" + msAutOccShop2PlusM + ")", "mf864"))
        specs.append(build_spec("mf865+" + "(mf806/" + msAutOccShop2PlusM + ")", "mf865"))
        ...
        specs.append(build_spec("mf877+" + "(mf786/" + msAutOccShop2Plus + ")", "mf877"))
        specs.append(build_spec("mf878+" + "(mf807/" + msAutOccShop2Plus + ")", "mf878"))
