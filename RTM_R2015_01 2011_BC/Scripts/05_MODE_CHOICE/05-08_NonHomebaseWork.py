...
class ModeChoiceNHBW(_m.Tool()):
    ...
    def run_model(self, scenario, eb, iteration_number, is_last_iteration):
        ...
        self.time_slice_non_home_base_work(scenario, data_folder)
    ...
    def time_slice_non_home_base_work(self, scenario, data_folder):
    ...
    def calculate_final_period_demand(self, scenario):
        ...
        specs.append(build_spec("mf844+" + "mf798", "mf844"))
        specs.append(build_spec("mf849+" + "(mf805/" + msAutOccNhbW2Plus + ")", "mf849"))
        ...
        specs.append(build_spec("mf998 + mf819*mf996", "mf998"))
        specs.append(build_spec("mf997 + mf826*mf992", "mf997"))
        #
        #    Midday
        #
        specs.append(build_spec("mf857+" + "mf799", "mf857"))
        specs.append(build_spec("mf862+" + "(mf806/" + msAutOccNhbW2PlusM + ")", "mf862"))
        ...
        #    PM peak hour
        #
        specs.append(build_spec("mf870+" + "mf800", "mf870"))
        specs.append(build_spec("mf875+" + "(mf807/" + msAutOccNhbW2Plus + ")", "mf875"))
