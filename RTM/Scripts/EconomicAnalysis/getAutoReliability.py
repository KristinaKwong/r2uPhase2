...
class getAutoReliability(_m.Tool()):
    ...
    def run(self):
        ...
        try:
            ...
            self(self.baseScenarioName, self.ensem, self.run_reliability_assignment, self.inc, self.compute_auto_reliability_benefit)
            self.tool_run_msg = _m.PageBuilder.format_info("Tool complete")
        except Exception, e:
            self.tool_run_msg = _m.PageBuilder.format_exception(e, _traceback.format_exc(e))

    @_m.logbook_trace("Trip Simulation")
    def  __call__(self, baseline_eb_title, ensem, run_reliability_assignment, inc, compute_auto_reliability_benefit):
