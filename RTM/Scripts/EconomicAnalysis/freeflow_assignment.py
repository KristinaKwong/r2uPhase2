...
##--
##--Path: EconomicAnalysis.ffassignment
...
class AutoAssignment(_m.Tool()):
    ...
    def run(self):
        ...
        try:
            ...
            self(eb, self.am_scenario, self.md_scenario, self.pm_scenario, self.assignment_type, self.inc)
            self.tool_run_msg = _m.PageBuilder.format_info("Tool complete")
        except Exception, e:
            self.tool_run_msg = _m.PageBuilder.format_exception(e, _traceback.format_exc(e))

    @_m.logbook_trace("Auto Traffic Assignment")
    def __call__(self, eb, am_scenario, md_scenario, pm_scenario,assignment_type, inc):

        util = _m.Modeller().tool("translink.util")
        util.initmat(eb, "ms12", "Processors", "Number of Processors for Computer Running Model", 4)
        # make sure we don't overwrite existing scenarios, increment scenario id by 100
        am_scenario, md_scenario, pm_scenario = self.losdscenarios(eb, am_scenario, md_scenario, pm_scenario, inc)
    ...
    def losdscenarios(self, eb, am_scenario, md_scenario, pm_scenario, inc = 1):
        ...
        #inc is increment to scenario id, make sure we don't overwrite other scenario

         # Copy to new AM Scenarios
        am_scenid = am_scenario.number + inc
        ...
        md_scenid = md_scenario.number + inc
        ...
        pm_scenid = pm_scenario.number + inc
    ...
    def calc_all(self, eb):
        ...
        self.calc_reliability(eb, am_coefs, 'AmSovRelVot1', 'mfAmSovTimeVOT1', 'mfAmSovTimeFreeflow', 'mfSkimAmSovDistVOT1')
        self.calc_reliability(eb, am_coefs, 'AmSovRelVot2', 'mfAmSovTimeVOT2', 'mfAmSovTimeFreeflow', 'mfSkimAmSovDistVOT2')
        self.calc_reliability(eb, am_coefs, 'AmSovRelVot3', 'mfAmSovTimeVOT3', 'mfAmSovTimeFreeflow', 'mfSkimAmSovDistVOT3')
        self.calc_reliability(eb, am_coefs, 'AmSovRelVot4', 'mfAmSovTimeVOT4', 'mfAmSovTimeFreeflow', 'mfSkimAmSovDistVOT4')
        self.calc_reliability(eb, am_coefs, 'AmHovRelVot1', 'mfAmHovTimeVOT1', 'mfAmHovTimeFreeflow', 'mfSkimAmHovDistVOT1')
        self.calc_reliability(eb, am_coefs, 'AmHovRelVot2', 'mfAmHovTimeVOT2', 'mfAmHovTimeFreeflow', 'mfSkimAmHovDistVOT2')
        self.calc_reliability(eb, am_coefs, 'AmHovRelVot3', 'mfAmHovTimeVOT3', 'mfAmHovTimeFreeflow', 'mfSkimAmHovDistVOT3')
        self.calc_reliability(eb, am_coefs, 'AmLgvRel', 'mfAmLgvTime', 'mfAmLgvTimeFreeflow', 'mfSkimAmLgvDist')
        self.calc_reliability(eb, am_coefs, 'AmHgvRel', 'mfAmHgvTime', 'mfAmHgvTimeFreeflow', 'mfSkimAmHgvDist')

        self.calc_reliability(eb, md_coefs, 'MdSovRelVot1', 'mfMdSovTimeVOT1', 'mfMdSovTimeFreeflow', 'mfSkimMdSovDistVOT1')
        self.calc_reliability(eb, md_coefs, 'MdSovRelVot2', 'mfMdSovTimeVOT2', 'mfMdSovTimeFreeflow', 'mfSkimMdSovDistVOT2')
        self.calc_reliability(eb, md_coefs, 'MdSovRelVot3', 'mfMdSovTimeVOT3', 'mfMdSovTimeFreeflow', 'mfSkimMdSovDistVOT3')
        self.calc_reliability(eb, md_coefs, 'MdSovRelVot4', 'mfMdSovTimeVOT4', 'mfMdSovTimeFreeflow', 'mfSkimMdSovDistVOT4')
        self.calc_reliability(eb, md_coefs, 'MdHovRelVot1', 'mfMdHovTimeVOT1', 'mfMdHovTimeFreeflow', 'mfSkimMdHovDistVOT1')
        self.calc_reliability(eb, md_coefs, 'MdHovRelVot2', 'mfMdHovTimeVOT2', 'mfMdHovTimeFreeflow', 'mfSkimMdHovDistVOT2')
        self.calc_reliability(eb, md_coefs, 'MdHovRelVot3', 'mfMdHovTimeVOT3', 'mfMdHovTimeFreeflow', 'mfSkimMdHovDistVOT3')
        self.calc_reliability(eb, md_coefs, 'MdLgvRel', 'mfMdLgvTime', 'mfMdLgvTimeFreeflow', 'mfSkimMdLgvDist')
        self.calc_reliability(eb, md_coefs, 'MdHgvRel', 'mfMdHgvTime', 'mfMdHgvTimeFreeflow', 'mfSkimMdHgvDist')

        self.calc_reliability(eb, pm_coefs, 'PmSovRelVot1', 'mfPmSovTimeVOT1', 'mfPmSovTimeFreeflow', 'mfSkimPmSovDistVOT1')
        self.calc_reliability(eb, pm_coefs, 'PmSovRelVot2', 'mfPmSovTimeVOT2', 'mfPmSovTimeFreeflow', 'mfSkimPmSovDistVOT2')
        self.calc_reliability(eb, pm_coefs, 'PmSovRelVot3', 'mfPmSovTimeVOT3', 'mfPmSovTimeFreeflow', 'mfSkimPmSovDistVOT3')
        self.calc_reliability(eb, pm_coefs, 'PmSovRelVot4', 'mfPmSovTimeVOT4', 'mfPmSovTimeFreeflow', 'mfSkimPmSovDistVOT4')
        self.calc_reliability(eb, pm_coefs, 'PmHovRelVot1', 'mfPmHovTimeVOT1', 'mfPmHovTimeFreeflow', 'mfSkimPmHovDistVOT1')
        self.calc_reliability(eb, pm_coefs, 'PmHovRelVot2', 'mfPmHovTimeVOT2', 'mfPmHovTimeFreeflow', 'mfSkimPmHovDistVOT2')
        self.calc_reliability(eb, pm_coefs, 'PmHovRelVot3', 'mfPmHovTimeVOT3', 'mfPmHovTimeFreeflow', 'mfSkimPmHovDistVOT3')
        self.calc_reliability(eb, pm_coefs, 'PmLgvRel', 'mfPmLgvTime', 'mfPmLgvTimeFreeflow', 'mfSkimPmLgvDist')
        self.calc_reliability(eb, pm_coefs, 'PmHgvRel', 'mfPmHgvTime', 'mfPmHgvTimeFreeflow', 'mfSkimPmHgvDist')
    ...
    def calc_reliability(self, eb, coefs, rel_mat, time_mat, fftime_mat, dist_mat):
        util = _m.Modeller().tool("translink.util")
        ...
        # log distance calc
        df_vars['dist'] = util.get_matrix_numpy(eb, dist_mat).flatten()
        ...
        util.set_matrix_numpy(eb, rel_mat, df_vars['sigma'].values)
        return df_vars
