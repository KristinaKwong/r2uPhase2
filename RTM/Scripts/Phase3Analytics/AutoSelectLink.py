...
##--
##--Path: translink.RTM3Analytics.AutoSelectLink
...
class AutoAssignment(_m.Tool()):
    ...
    def __call__(self, am_scenario, md_scenario, pm_scenario):
        ...
        self.selectlink_batchinM(am_scenario)
        ...
        self.assign_scen(am_scenario, am_demands,"AM")
        ...
        self.assign_scen(md_scenario, md_demands,"MD")
        ...
        self.assign_scen(pm_scenario, pm_demands,"PM")
        ...
        self.selectlink_Combine(am_scenario)

    def assign_scen(self, scenario, demands, TOD):
        assign_traffic = _m.Modeller().tool("inro.emme.traffic_assignment.sola_traffic_assignment")
        
        self.selectlink_batchinA(scenario)
        ...
        self.add_select_link_analysis(spec, TOD)
        # run assignment
        ...
        util.emme_link_calc(scenario, "@autoselected", "@sovselect1+@sovselect2+@sovselect3+@sovselect4+@hovselect1+@hovselect2+@hovselect3+@lgvselect/1.5+@hgvselect/2.5")
    ...
    def add_select_link_analysis(self, spec, TOD):
        #@select needs to be replaced by actual select-link attribute
        commonspecs={"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}}
        #od_values save select link as matrix, #select_link_volumes save select link as extra attribute
        spec["classes"][ 0]["path_analyses"].append({"results": {"od_values": "mf%sSOVselectlink1"%(TOD),"selected_link_volumes": "@sovselect1"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 1]["path_analyses"].append({"results": {"od_values": "mf%sSOVselectlink2"%(TOD),"selected_link_volumes": "@sovselect2"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 2]["path_analyses"].append({"results": {"od_values": "mf%sSOVselectlink3"%(TOD),"selected_link_volumes": "@sovselect3"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 3]["path_analyses"].append({"results": {"od_values": "mf%sSOVselectlink4"%(TOD),"selected_link_volumes": "@sovselect4"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 4]["path_analyses"].append({"results": {"od_values": "mf%sHOVselectlink1"%(TOD),"selected_link_volumes": "@hovselect1"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 5]["path_analyses"].append({"results": {"od_values": "mf%sHOVselectlink2"%(TOD),"selected_link_volumes": "@hovselect2"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 6]["path_analyses"].append({"results": {"od_values": "mf%sHOVselectlink3"%(TOD),"selected_link_volumes": "@hovselect3"},"link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 7]["path_analyses"].append({"results": {"od_values": "mf%sLGVselectlink"%(TOD), "selected_link_volumes": "@lgvselect"}, "link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
        spec["classes"][ 8]["path_analyses"].append({"results": {"od_values": "mf%sHGVselectlink"%(TOD), "selected_link_volumes": "@hgvselect"}, "link_component": "@selectlink","operator": ".max.","selection_threshold": {"lower": 1, "upper": 1},"path_to_od_composition": {"considered_paths": "SELECTED", "multiply_path_proportions_by": {"analyzed_demand": True,"path_value": False}}})
    ...
    def selectlink_batchinA(self,scen):
        ...
        # creat select link attibutes, overwrite if exist
        create_attr("LINK", "@sovselect1", "SOV Select 1",0, True, scen)
        create_attr("LINK", "@sovselect2", "SOV Select 2",0, True, scen)
        create_attr("LINK", "@sovselect3", "SOV Select 3",0, True, scen)
        create_attr("LINK", "@sovselect4", "SOV Select 4",0, True, scen)
        create_attr("LINK", "@hovselect1", "HOV Select 1",0, True, scen)
        create_attr("LINK", "@hovselect2", "HOV Select 2",0, True, scen)
        create_attr("LINK", "@hovselect3", "HOV Select 3",0, True, scen)
        create_attr("LINK", "@lgvselect",  "LGV Select",0, True, scen)
        create_attr("LINK", "@hgvselect",  "HGV Select",0, True, scen)
        create_attr("LINK", "@autoselected",  "Auto Total Select",0, True, scen)

    def selectlink_batchinM(self,scen):
        create_matrix = _m.Modeller().tool("inro.emme.data.matrix.create_matrix")
        # creat select link matrices, overwrite if exist
        create_matrix("mf100", "AMSOVselectlink1", "AM SOV Select 1",0, True, scen)
        create_matrix("mf101", "AMSOVselectlink2", "AM SOV Select 2",0, True, scen)
        create_matrix("mf102", "AMSOVselectlink3", "AM SOV Select 3",0, True, scen)
        create_matrix("mf103", "AMSOVselectlink4", "AM SOV Select 4",0, True, scen)
        create_matrix("mf104", "AMHOVselectlink1", "AM HOV Select 1",0, True, scen)
        create_matrix("mf105", "AMHOVselectlink2", "AM HOV Select 2",0, True, scen)
        create_matrix("mf106", "AMHOVselectlink3", "AM HOV Select 3",0, True, scen)
        create_matrix("mf107", "AMLGVselectlink",  "AM LGV Select",0, True, scen)
        create_matrix("mf108", "AMHGVselectlink",  "AM HGV Select",0, True, scen)
        create_matrix("mf109", "AMTotalselectlink","AM HGV Select",0, True, scen)
        create_matrix("mf120", "MDSOVselectlink1", "MD SOV Select 1",0, True, scen)
        create_matrix("mf121", "MDSOVselectlink2", "MD SOV Select 2",0, True, scen)
        create_matrix("mf122", "MDSOVselectlink3", "MD SOV Select 3",0, True, scen)
        create_matrix("mf123", "MDSOVselectlink4", "MD SOV Select 4",0, True, scen)
        create_matrix("mf124", "MDHOVselectlink1", "MD HOV Select 1",0, True, scen)
        create_matrix("mf125", "MDHOVselectlink2", "MD HOV Select 2",0, True, scen)
        create_matrix("mf126", "MDHOVselectlink3", "MD HOV Select 3",0, True, scen)
        create_matrix("mf127", "MDLGVselectlink",  "MD LGV Select",0, True, scen)
        create_matrix("mf128", "MDHGVselectlink",  "MD HGV Select",0, True, scen)
        create_matrix("mf129", "MDTotalselectlink","MD HGV Select",0, True, scen)
        create_matrix("mf140", "PMSOVselectlink1", "PM SOV Select 1",0, True, scen)
        create_matrix("mf141", "PMSOVselectlink2", "PM SOV Select 2",0, True, scen)
        create_matrix("mf142", "PMSOVselectlink3", "PM SOV Select 3",0, True, scen)
        create_matrix("mf143", "PMSOVselectlink4", "PM SOV Select 4",0, True, scen)
        create_matrix("mf144", "PMHOVselectlink1", "PM HOV Select 1",0, True, scen)
        create_matrix("mf145", "PMHOVselectlink2", "PM HOV Select 2",0, True, scen)
        create_matrix("mf146", "PMHOVselectlink3", "PM HOV Select 3",0, True, scen)
        create_matrix("mf147", "PMLGVselectlink",  "PM LGV Select",0, True, scen)
        create_matrix("mf148", "PMHGVselectlink",  "PM HGV Select",0, True, scen)
        create_matrix("mf149", "PMTotalselectlink","PM HGV Select",0, True, scen)
        
    def selectlink_Combine(self,scen):
        util = _m.Modeller().tool("translink.util")
        specs = []
        specs.append(util.matrix_spec("mfAMTotalselectlink", "mfAMSOVselectlink1+mfAMSOVselectlink2+mfAMSOVselectlink3+mfAMSOVselectlink4+mfAMHOVselectlink1+mfAMHOVselectlink2+mfAMHOVselectlink3+AMLGVselectlink/1.5+AMHGVselectlink/2.5"))
        specs.append(util.matrix_spec("mfMDTotalselectlink", "mfMDSOVselectlink1+mfMDSOVselectlink2+mfMDSOVselectlink3+mfMDSOVselectlink4+mfMDHOVselectlink1+mfMDHOVselectlink2+mfMDHOVselectlink3+MDLGVselectlink/1.5+MDHGVselectlink/2.5"))
        specs.append(util.matrix_spec("mfPMTotalselectlink", "mfPMSOVselectlink1+mfPMSOVselectlink2+mfPMSOVselectlink3+mfPMSOVselectlink4+mfPMHOVselectlink1+mfPMHOVselectlink2+mfPMHOVselectlink3+PMLGVselectlink/1.5+PMHGVselectlink/2.5"))
        util.compute_matrix(specs, scen)
