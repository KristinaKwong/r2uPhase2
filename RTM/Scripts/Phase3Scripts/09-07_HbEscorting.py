...
class HbEscorting(_m.Tool()):
    ...
    def __call__(self, eb, Bus_Bias, Rail_Bias, WCE_Bias):
        ...
        tnc_occupancy = float(util.get_matrix_numpy(eb, 'TNCOccHbesc'))  # TNC Occupancy
        tnc_av_rate = 0.0
...
#        ##############################################################################
        ...
        Df['TNCCost'] = util.get_matrix_numpy(eb, 'HbEsBlTNCCost')

        # TNC Accessibbility
        Df['TNCAccess'] = util.get_matrix_numpy(eb,'tncAccLn')
        ...
        # TNC
        DfU['TNC'] = (p30
                       + p12 * (Df['AutoTimHOV']+ tnc_wait_percep* Df['TNCWaitTime'])*VOT/60
...
#        ##############################################################################
        ...
        A1_Dict = MChM.Calc_Prob(eb, Dict, "HbEsLSA1", thet, 'hbescatr', LS_Coeff, modes_dict, taz_list)
        ...
        A2_Dict = MChM.Calc_Prob(eb, Dict, "HbEsLSA2", thet, 'hbescatr', LS_Coeff, modes_dict, taz_list)
...
#       ##############################################################################
        ...
        I1A0_Dict = MChM.Calc_Demand(eb, A0_Dict, "HbEsP-AI1A0")
        I1A1_Dict = MChM.Calc_Demand(eb, A1_Dict, "HbEsP-AI1A1")
        I1A2_Dict = MChM.Calc_Demand(eb, A2_Dict, "HbEsP-AI1A2")
        I2A0_Dict = MChM.Calc_Demand(eb, A0_Dict, "HbEsP-AI2A0")
        I2A1_Dict = MChM.Calc_Demand(eb, A1_Dict, "HbEsP-AI2A1")
        I2A2_Dict = MChM.Calc_Demand(eb, A2_Dict, "HbEsP-AI2A2")
        I3A0_Dict = MChM.Calc_Demand(eb, A0_Dict, "HbEsP-AI3A0")
        I3A1_Dict = MChM.Calc_Demand(eb, A1_Dict, "HbEsP-AI3A1")
        I3A2_Dict = MChM.Calc_Demand(eb, A2_Dict, "HbEsP-AI3A2")
...
#       ##############################################################################
      ...
      ## SOV Trips      #SOV*PA_Factor + SOV_transpose*AP_Factor
        ...
        AuDr_HOVI1_AM = HOVI1_AM/HOcc + HOV_TNCI1_AM
        AuDr_HOVI1_MD = HOVI1_MD/HOcc + HOV_TNCI1_MD
        AuDr_HOVI1_PM = HOVI1_PM/HOcc + HOV_TNCI1_PM

        AuDr_HOVI2_AM = HOVI2_AM/HOcc + HOV_TNCI2_AM
        AuDr_HOVI2_MD = HOVI2_MD/HOcc + HOV_TNCI2_MD
        AuDr_HOVI2_PM = HOVI2_PM/HOcc + HOV_TNCI2_PM

        AuDr_HOVI3_AM = HOVI3_AM/HOcc + HOV_TNCI3_AM
        AuDr_HOVI3_MD = HOVI3_MD/HOcc + HOV_TNCI3_MD
        AuDr_HOVI3_PM = HOVI3_PM/HOcc + HOV_TNCI3_PM
...
#       ##############################################################################
        ...
        util.set_matrix_numpy(eb, "HbEsTNCI1PerTrips", TNCI1)
        util.set_matrix_numpy(eb, "HbEsTNCI2PerTrips", TNCI2)
        util.set_matrix_numpy(eb, "HbEsTNCI3PerTrips", TNCI3)
    ...
    def matrix_batchins(self, eb):
        ...
        util.initmat(eb, "mf9360", "HbEsLSAUA0", " HbEs LogSum Auto A0", 0)
        util.initmat(eb, "mf9361", "HbEsLSAUA1", " HbEs LogSum Auto A1", 0)
        util.initmat(eb, "mf9362", "HbEsLSAUA2", " HbEs LogSum Auto A2", 0)

        util.initmat(eb, "mf9460", "HbEsLSTRA0", " HbEs LogSum Transit A0", 0)
        util.initmat(eb, "mf9461", "HbEsLSTRA1", " HbEs LogSum Transit A1", 0)
        util.initmat(eb, "mf9462", "HbEsLSTRA2", " HbEs LogSum Transit A2", 0)

        util.initmat(eb, "mf9560", "HbEsLSACA0", " HbEs LogSum Active A0", 0)
        util.initmat(eb, "mf9561", "HbEsLSACA1", " HbEs LogSum Active A1", 0)
        util.initmat(eb, "mf9562", "HbEsLSACA2", " HbEs LogSum Active A2", 0)
        ...
        util.initmat(eb, "mf3640", "HbEsTNCI1PerTrips", "HbEs TNC Low Income Per-Trips", 0)
        util.initmat(eb, "mf3641", "HbEsTNCI2PerTrips", "HbEs TNC Med Income Per-Trips", 0)
        util.initmat(eb, "mf3642", "HbEsTNCI3PerTrips", "HbEs TNC High Income Per-Trips", 0)
