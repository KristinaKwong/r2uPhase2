...
class DataImport(_m.Tool()):
    ...
    def starter_skims(self, eb, horizon_year):
        ...
        util.set_matrix_numpy(eb, "mfAmSovOpCstVOT1I1", df['AmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfAmSovOpCstVOT2I1", df['AmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfAmHovOpCstVOT1I1",  df['AmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfAmHovOpCstVOT2I1", df['AmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfMdSovOpCstVOT1I1", df['MdAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfMdSovOpCstVOT2I1", df['MdAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfMdHovOpCstVOT1I1",  df['MdAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfMdHovOpCstVOT2I1", df['MdAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfPmSovOpCstVOT1I1", df['PmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfPmSovOpCstVOT2I1", df['PmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfPmHovOpCstVOT1I1",  df['PmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        util.set_matrix_numpy(eb, "mfPmHovOpCstVOT2I1", df['PmAutoOpCst'].values.reshape(NoTAZ, NoTAZ))
        ...
        tnc_dist = df['AmAutoOpCst'].values.reshape(NoTAZ, NoTAZ) / eb.matrix("msautoOpCost").data
