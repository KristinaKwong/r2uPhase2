...
def export_auto(eb, scenario_name):
    ...
    df['amSovTime1'] = util.get_matrix_numpy(eb, "mfAmSovOriginalTIMAU1").flatten()
    #f['amSovTime2'] = util.get_matrix_numpy(eb, "mfAmSovOriginalTIMAU2").flatten()
    #f['amSovTime3'] = util.get_matrix_numpy(eb, "mfAmSovOriginalTIMAU3").flatten()
    df['amSovTime4'] = util.get_matrix_numpy(eb, "mfAmSovOriginalTIMAU4").flatten()
    df['mdSovTime1'] = util.get_matrix_numpy(eb, "mfMdSovOriginalTIMAU1").flatten()
    #f['mdSovTime2'] = util.get_matrix_numpy(eb, "mfMdSovOriginalTIMAU2").flatten()
    #f['mdSovTime3'] = util.get_matrix_numpy(eb, "mfMdSovOriginalTIMAU3").flatten()
    df['mdSovTime4'] = util.get_matrix_numpy(eb, "mfMdSovOriginalTIMAU4").flatten()
    df['pmSovTime1'] = util.get_matrix_numpy(eb, "mfPmSovOriginalTIMAU1").flatten()
    #f['pmSovTime2'] = util.get_matrix_numpy(eb, "mfPmSovOriginalTIMAU2").flatten()
    #f['pmSovTime3'] = util.get_matrix_numpy(eb, "mfPmSovOriginalTIMAU3").flatten()
    df['pmSovTime4'] = util.get_matrix_numpy(eb, "mfPmSovOriginalTIMAU4").flatten()
    df['amHovTime1'] = util.get_matrix_numpy(eb, "mfAmHovOriginalTIMAU1").flatten()
    #f['amHovTime2'] = util.get_matrix_numpy(eb, "mfAmHovOriginalTIMAU2").flatten()
    df['amHovTime3'] = util.get_matrix_numpy(eb, "mfAmHovOriginalTIMAU3").flatten()
    #f['amHovTime4'] = 0
    df['mdHovTime1'] = util.get_matrix_numpy(eb, "mfMdHovOriginalTIMAU1").flatten()
    #f['mdHovTime2'] = util.get_matrix_numpy(eb, "mfMdHovOriginalTIMAU2").flatten()
    df['mdHovTime3'] = util.get_matrix_numpy(eb, "mfMdHovOriginalTIMAU3").flatten()
    #f['mdHovTime4'] = 0
    df['pmHovTime1'] = util.get_matrix_numpy(eb, "mfPmHovOriginalTIMAU1").flatten()
    #f['pmHovTime2'] = util.get_matrix_numpy(eb, "mfPmHovOriginalTIMAU2").flatten()
    df['pmHovTime3'] = util.get_matrix_numpy(eb, "mfPmHovOriginalTIMAU3").flatten()
    #f['pmHovTime4'] = 0
    ...
    dfToll['amSovToll1'] = util.get_matrix_numpy(eb, "mfAmSovSocialCost1").flatten()
    #fToll['amSovToll2'] = util.get_matrix_numpy(eb, "mfAmSovSocialCost2").flatten()
    #fToll['amSovToll3'] = util.get_matrix_numpy(eb, "mfAmSovSocialCost3").flatten()
    dfToll['amSovToll4'] = util.get_matrix_numpy(eb, "mfAmSovSocialCost4").flatten()
    dfToll['mdSovToll1'] = util.get_matrix_numpy(eb, "mfMdSovSocialCost1").flatten()
    #fToll['mdSovToll2'] = util.get_matrix_numpy(eb, "mfMdSovSocialCost2").flatten()
    #fToll['mdSovToll3'] = util.get_matrix_numpy(eb, "mfMdSovSocialCost3").flatten()
    dfToll['mdSovToll4'] = util.get_matrix_numpy(eb, "mfMdSovSocialCost4").flatten()
    dfToll['pmSovToll1'] = util.get_matrix_numpy(eb, "mfPmSovSocialCost1").flatten()
    #fToll['pmSovToll2'] = util.get_matrix_numpy(eb, "mfPmSovSocialCost2").flatten()
    #fToll['pmSovToll3'] = util.get_matrix_numpy(eb, "mfPmSovSocialCost3").flatten()
    dfToll['pmSovToll4'] = util.get_matrix_numpy(eb, "mfPmSovSocialCost4").flatten()
    dfToll['amHovToll1'] = util.get_matrix_numpy(eb, "mfAmHovSocialCost1").flatten()
    #fToll['amHovToll2'] = util.get_matrix_numpy(eb, "mfAmHovSocialCost2").flatten()
    dfToll['amHovToll3'] = util.get_matrix_numpy(eb, "mfAmHovSocialCost3").flatten()
    #fToll['amHovToll4'] = 0
    dfToll['mdHovToll1'] = util.get_matrix_numpy(eb, "mfMdHovSocialCost1").flatten()
    #fToll['mdHovToll2'] = util.get_matrix_numpy(eb, "mfMdHovSocialCost2").flatten()
    dfToll['mdHovToll3'] = util.get_matrix_numpy(eb, "mfMdHovSocialCost3").flatten()
    #fToll['mdHovToll4'] = 0
    dfToll['pmHovToll1'] = util.get_matrix_numpy(eb, "mfPmHovSocialCost1").flatten()
    #fToll['pmHovToll2'] = util.get_matrix_numpy(eb, "mfPmHovSocialCost2").flatten()
    dfToll['pmHovToll3'] = util.get_matrix_numpy(eb, "mfPmHovSocialCost3").flatten()
    #fToll['pmHovToll4'] = 0
    ...
    dfToll['tolls'] = np.where(dfToll['peak'] == 'am', dfToll['tolls'] * VOTam, dfToll['tolls'])       
    dfToll['tolls'] = np.where(dfToll['peak'] == 'md', dfToll['tolls'] * VOTmd, dfToll['tolls'])
    dfToll['tolls'] = np.where(dfToll['peak'] == 'pm', dfToll['tolls'] * VOTpm, dfToll['tolls'])
    ...
    # df = df[['scenario','peak', 'mode', 'votclass', 'i', 'j', 'total_mins', 'tolls', 'dist','cong_time', 'losd_time']]
    df.i = df.i.astype(int)
    df.j = df.j.astype(int)
    # df.votclass = df.votclass.astype(int)
