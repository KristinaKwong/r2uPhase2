...
def export_auto(eb, scenario_name, use_cong=False):
    util = _m.Modeller().tool("translink.util")
    df = pd.concat([util.get_pd_ij_df(eb),util.get_ijensem_df(eb, 'gy','gy')], axis=1)


    # baseline everything is weighted by this, so keep disaggrate until late
    # aggregate everything else sooner to clear memory
    ...
    dfToll['amSovToll1'] = df['amSovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimAmSovTollVOT1").flatten(), axis = 0)
    dfToll['amSovToll2'] = df['amSovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimAmSovTollVOT2").flatten(), axis = 0)
    dfToll['amSovToll3'] = df['amSovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimAmSovTollVOT3").flatten(), axis = 0)
    dfToll['amSovToll4'] = df['amSovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimAmSovTollVOT4").flatten(), axis = 0)
    dfToll['mdSovToll1'] = df['mdSovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimMdSovTollVOT1").flatten(), axis = 0)
    dfToll['mdSovToll2'] = df['mdSovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimMdSovTollVOT2").flatten(), axis = 0)
    dfToll['mdSovToll3'] = df['mdSovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimMdSovTollVOT3").flatten(), axis = 0)
    dfToll['mdSovToll4'] = df['mdSovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimMdSovTollVOT4").flatten(), axis = 0)
    dfToll['pmSovToll1'] = df['pmSovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimPmSovTollVOT1").flatten(), axis = 0)
    dfToll['pmSovToll2'] = df['pmSovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimPmSovTollVOT2").flatten(), axis = 0)
    dfToll['pmSovToll3'] = df['pmSovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimPmSovTollVOT3").flatten(), axis = 0)
    dfToll['pmSovToll4'] = df['pmSovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimPmSovTollVOT4").flatten(), axis = 0)
    dfToll['amHovToll1'] = df['amHovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimAmHovTollVOT1").flatten(), axis = 0)
    dfToll['amHovToll2'] = df['amHovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimAmHovTollVOT2").flatten(), axis = 0)
    dfToll['amHovToll3'] = df['amHovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimAmHovTollVOT3").flatten(), axis = 0)
    dfToll['amHovToll4'] = df['amHovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimAmHovTollVOT4").flatten(), axis = 0)
    dfToll['mdHovToll1'] = df['mdHovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimMdHovTollVOT1").flatten(), axis = 0)
    dfToll['mdHovToll2'] = df['mdHovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimMdHovTollVOT2").flatten(), axis = 0)
    dfToll['mdHovToll3'] = df['mdHovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimMdHovTollVOT3").flatten(), axis = 0)
    dfToll['mdHovToll4'] = df['mdHovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimMdHovTollVOT4").flatten(), axis = 0)
    dfToll['pmHovToll1'] = df['pmHovDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimPmHovTollVOT1").flatten(), axis = 0)
    dfToll['pmHovToll2'] = df['pmHovDemand2'].multiply(util.get_matrix_numpy(eb, "mfSkimPmHovTollVOT2").flatten(), axis = 0)
    dfToll['pmHovToll3'] = df['pmHovDemand3'].multiply(util.get_matrix_numpy(eb, "mfSkimPmHovTollVOT3").flatten(), axis = 0)
    dfToll['pmHovToll4'] = df['pmHovDemand4'].multiply(util.get_matrix_numpy(eb, "mfSkimPmHovTollVOT4").flatten(), axis = 0)
    dfToll['amLGVToll1'] = df['amLGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimAmLgvToll").flatten(), axis = 0)
    dfToll['amHGVToll1'] = df['amHGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimAmHgvToll").flatten(), axis = 0)
    dfToll['mdLGVToll1'] = df['mdLGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimMdLgvToll").flatten(), axis = 0)
    dfToll['mdHGVToll1'] = df['mdHGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimMdHgvToll").flatten(), axis = 0)
    dfToll['pmLGVToll1'] = df['pmLGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimPmLgvToll").flatten(), axis = 0)
    dfToll['pmHGVToll1'] = df['pmHGVDemand1'].multiply(util.get_matrix_numpy(eb, "mfSkimPmHgvToll").flatten(), axis = 0)    
...
if __name__ == '__main__':
    ...
    for eb in ebs:
        ...
        try:
            export_auto(eb, title, use_cong=True)
