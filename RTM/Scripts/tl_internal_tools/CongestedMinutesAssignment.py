...
class AutoAssignment(_m.Tool()):
    ...
    def __call__(self, eb, am_scenario, md_scenario, pm_scenario, attribute_to_skim, assignment_type):
        ...
        util.initmat(eb, "mf9500", "AmSovTimeCongVOT1",  "AM SOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9501", "AmSovTimeCongVOT2",  "AM SOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9502", "AmSovTimeCongVOT3",  "AM SOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9503", "AmSovTimeCongVOT4",  "AM SOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9505", "AmHovTimeCongVOT1",  "AM HOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9506", "AmHovTimeCongVOT2",  "AM HOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9507", "AmHovTimeCongVOT3",  "AM HOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9508", "AmHovTimeCongVOT4",  "AM HOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9510", "AmLgvTimeCong",      "AM LGV Minutes Cong", 0)
        util.initmat(eb, "mf9511", "AmHgvTimeCong",      "AM HGV Minutes Cong", 0)

        util.initmat(eb, "mf9520", "MdSovTimeCongVOT1",  "MD SOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9521", "MdSovTimeCongVOT2",  "MD SOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9522", "MdSovTimeCongVOT3",  "MD SOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9523", "MdSovTimeCongVOT4",  "MD SOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9525", "MdHovTimeCongVOT1",  "MD HOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9526", "MdHovTimeCongVOT2",  "MD HOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9527", "MdHovTimeCongVOT3",  "MD HOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9528", "MdHovTimeCongVOT4",  "MD HOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9530", "MdLgvTimeCong",      "MD LGV Minutes Cong", 0)
        util.initmat(eb, "mf9531", "MdHgvTimeCong",      "MD HGV Minutes Cong", 0)


        util.initmat(eb, "mf9540", "PmSovTimeCongVOT1",  "PM SOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9541", "PmSovTimeCongVOT2",  "PM SOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9542", "PmSovTimeCongVOT3",  "PM SOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9543", "PmSovTimeCongVOT4",  "PM SOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9545", "PmHovTimeCongVOT1",  "PM HOV Minutes Cong VOT1", 0)
        util.initmat(eb, "mf9546", "PmHovTimeCongVOT2",  "PM HOV Minutes Cong VOT2", 0)
        util.initmat(eb, "mf9547", "PmHovTimeCongVOT3",  "PM HOV Minutes Cong VOT3", 0)
        util.initmat(eb, "mf9548", "PmHovTimeCongVOT4",  "PM HOV Minutes Cong VOT4", 0)
        util.initmat(eb, "mf9550", "PmLgvTimeCong",      "PM LGV Minutes Cong", 0)
        util.initmat(eb, "mf9551", "PmHgvTimeCong",      "PM HGV Minutes Cong", 0)


        # Initialize skim matrices by time period for LOSD
        util.initmat(eb, "mf9560", "AmSovTimeLOSDVOT1",  "AM SOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9561", "AmSovTimeLOSDVOT2",  "AM SOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9562", "AmSovTimeLOSDVOT3",  "AM SOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9563", "AmSovTimeLOSDVOT4",  "AM SOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9565", "AmHovTimeLOSDVOT1",  "AM HOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9566", "AmHovTimeLOSDVOT2",  "AM HOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9567", "AmHovTimeLOSDVOT3",  "AM HOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9568", "AmHovTimeLOSDVOT4",  "AM HOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9570", "AmLgvTimeLOSD",      "AM LGV Minutes LOSD", 0)
        util.initmat(eb, "mf9571", "AmHgvTimeLOSD",      "AM HGV Minutes LOSD", 0)

        util.initmat(eb, "mf9580", "MdSovTimeLOSDVOT1",  "MD SOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9581", "MdSovTimeLOSDVOT2",  "MD SOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9582", "MdSovTimeLOSDVOT3",  "MD SOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9583", "MdSovTimeLOSDVOT4",  "MD SOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9585", "MdHovTimeLOSDVOT1",  "MD HOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9586", "MdHovTimeLOSDVOT2",  "MD HOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9587", "MdHovTimeLOSDVOT3",  "MD HOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9588", "MdHovTimeLOSDVOT4",  "MD HOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9590", "MdLgvTimeLOSD",      "MD LGV Minutes LOSD", 0)
        util.initmat(eb, "mf9591", "MdHgvTimeLOSD",      "MD HGV Minutes LOSD", 0)

        util.initmat(eb, "mf9600", "PmSovTimeLOSDVOT1",  "PM SOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9601", "PmSovTimeLOSDVOT2",  "PM SOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9602", "PmSovTimeLOSDVOT3",  "PM SOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9603", "PmSovTimeLOSDVOT4",  "PM SOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9605", "PmHovTimeLOSDVOT1",  "PM HOV Minutes LOSD VOT1", 0)
        util.initmat(eb, "mf9606", "PmHovTimeLOSDVOT2",  "PM HOV Minutes LOSD VOT2", 0)
        util.initmat(eb, "mf9607", "PmHovTimeLOSDVOT3",  "PM HOV Minutes LOSD VOT3", 0)
        util.initmat(eb, "mf9608", "PmHovTimeLOSDVOT4",  "PM HOV Minutes LOSD VOT4", 0)
        util.initmat(eb, "mf9610", "PmLgvTimeLOSD",      "PM LGV Minutes LOSD", 0)
        util.initmat(eb, "mf9611", "PmHgvTimeLOSD",      "PM HGV Minutes LOSD", 0)
...
#        util.emme_link_calc(scenario, "@timeeff", "40", sel_link = "vdf = 2")
    ...
    def losdscenarios(self, eb, am_scenario, md_scenario, pm_scenario):
        ...
        am_scenid = am_scenario.number + 737
        ...
        md_scenid = md_scenario.number + 737
        ...
        pm_scenid = pm_scenario.number + 737
